...
//            System.out.println(el);
    ...
    public void insertDB(String uID, String uFirstName, String uLastName, String uAddress, String uEmail, String uPassWd, String uType) {
        try {
            ...
            Statement stmt = con.createStatement();
            // =========================================INSERT STATEMENT==============================================================
            String sql = "INSERT INTO Users (UserID, FirstName, LastName, Address, Email, Password, Type) " +
...
/******************************************************************************************************
 * Testing section of the Users data functions that were used to verify each function worked
 ******************************************************************************************************/
