...
public class ProcessorLoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /******************************************************************
         * Get ID and Password from User for Client
         * ****************************************************************/
        ...
        try {
            ...
            //Verify both fields have data if not send to error page
            if (id == "" || pw == "") {
                /************************************************************************************
            ...
            if (dbPassword != null && dbPassword.equals(pw)) {
                u1.getuserID(); //Call getOrders list //////and pass the id to get AppointmentsMethod()*****************
                out.println("userID");
                ...
                ses1.setAttribute("ordersList", o2);      //Pass the info to the ChangeOrdStatPage
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            //           usersInfo.updateDB(request.getParameter("uID"), request.getParameter("uFirstName"),
//                    request.getParameter("uLastName"), request.getParameter("uEmail"),
//                    request.getParameter("pPatAddress"), request.getParameter("uPassWd"));
         ...
         *
         * // INSTANTIATE PATIENTS HERE TO LOOP BACK AROUND TO THE Patients INFO PAGE
         * ***************************************************************************/

        Users p2 = new Users();
        HttpSession ses1;
        p2.selectDB(Integer.parseInt(request.getParameter("UserID")));
        ses1 = request.getSession();
        ses1.setAttribute("user1", p2); // places Patients ID into the session
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/ClientInfoPage.jsp"); // Calls/Opens Patients Information check/change page
        rd.forward(request, response);
    }
}